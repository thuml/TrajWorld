...
"""
python scripts/pretrain/pretrain_tdm.py history_length=20 log_root_dir=log_pretrain_tdm exp_name=merge_all n_blocks=6 embed_dim=384
"""
...
if __name__ == "__main__":
    ...
    model = TDM_Dynamics(config, max_values=1.0, min_values=0.0)
